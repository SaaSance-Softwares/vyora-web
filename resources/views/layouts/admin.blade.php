    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-40">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1 custom-scrollbar">
                ...
                <div class="pt-4 pb-2">
                    <p class="px-3 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Sales & Customers</p>
                </div>
                ...
                <a href="{{ route('admin.abandoned-carts.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.abandoned-carts.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                ...
                @php
                    $isWhatsappEnabled = \App\Models\ThemeSetting::where('group', 'integration.whatsapp')->where('key', 'enabled')->value('value') === '1';
                    $isTwilioEnabled = \App\Models\ThemeSetting::where('group', 'integration.twilio')->where('key', 'enabled')->value('value') === '1';
                    $isSmtpEnabled = \App\Models\ThemeSetting::where('group', 'integration.smtp')->where('key', 'enabled')->value('value') === '1';
                @endphp

                @if($isWhatsappEnabled || $isTwilioEnabled || $isSmtpEnabled)
                <div class="pt-4 pb-2">
                    <p class="px-3 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Communications</p>
                </div>
                @endif

                @if($isWhatsappEnabled)
                <a href="{{ route('admin.whatsapp.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.whatsapp.index', 'admin.whatsapp.messages') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                    <span class="text-sm">WhatsApp Chat</span>
                    @if(\App\Models\WhatsappMessage::where('direction', 'inbound')->where('status', '!=', 'read')->exists())
                        <span class="ml-auto w-2 h-2 bg-red-500 rounded-full"></span>
                    @endif
                </a>

                <a href="{{ route('admin.whatsapp.templates.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.whatsapp.templates.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    <span class="text-sm">WhatsApp Templates</span>
                </a>
                @endif

                @if($isTwilioEnabled)
                <a href="{{ route('admin.sms-templates.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.sms-templates.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                ...
                @if($isSmtpEnabled)
                <a href="{{ route('admin.email-templates.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.email-templates.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                ...
                <div class="pt-4 pb-2">
                    <p class="px-3 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Marketing & Growth</p>
                </div>
                ...
                <a href="{{ route('admin.newsletter-subscribers.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.newsletter-subscribers.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    <span class="text-sm">Email Subscribers</span>
                </a>
                ...
                <a href="{{ route('admin.online-store.footer-settings.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.online-store.footer-settings.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16h16"></path>
                    </svg>
                ...
                <a href="{{ route('admin.online-store.policy-settings.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.online-store.policy-settings.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    ...
                    <span class="text-sm">Short PDP Policies</span>
                </a>

                <a href="{{ route('admin.legal-pages.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.legal-pages.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    <span class="text-sm">Legal & Policy Pages</span>
                </a>

                <a href="{{ route('admin.online-store.custom-code.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.online-store.custom-code.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
                    <span class="text-sm">Custom Code</span>
                </a>
                ...
                <a href="{{ route('admin.order-statuses.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.order-statuses.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                    <span class="text-sm">Order Statuses</span>
                </a>

<a href="{{ route('admin.online-store.delivery-timelines.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.online-store.delivery-timelines.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span class="text-sm">Delivery Timelines</span>
                </a>
                ...
                <a href="{{ route('admin.online-store.localization.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.online-store.localization.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                ...
                <a href="{{ route('admin.settings.redirects.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.settings.redirects.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                    <span class="text-sm">301 Redirects</span>
                </a>
                ...
                <div class="pt-4 pb-2">
                    <p class="px-3 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Point of Sale</p>
                </div>
                @php
                    $isPosEnabled = \App\Models\ThemeSetting::where('group', 'pos_settings')->where('key', 'pos_enabled')->value('value') === '1';
                @endphp
                
                @if($isPosEnabled)
                <a href="{{ route('admin.pos-analysis.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.pos-analysis.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    <span class="text-sm">POS Analysis</span>
                </a>
                @endif
                
                <a href="{{ route('admin.pos-settings.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.pos-settings.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    <span class="text-sm">Point of Sale Setting</span>
                </a>

                @if($isPosEnabled)
                <a href="{{ route('admin.pos-markets.index') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.pos-markets.*') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                    <span class="text-sm">Store & Inventory</span>
                </a>
                @endif
                ...
                <a href="{{ route('admin.mobile-app') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.mobile-app') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                    <span class="text-sm">Mobile App</span>
                </a>

                <a href="{{ route('admin.settings.cron') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.settings.cron') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <span class="text-sm">Cron Jobs</span>
                </a>

                <a href="{{ route('admin.settings.logs') }}" class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('admin.settings.logs') ? 'bg-gray-100 text-black font-semibold' : 'text-gray-600 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
        ...
        <div class="flex-1 ml-64 flex flex-col min-w-0">
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-30">
                ...
                <div class="flex items-center space-x-5">
                    ...
                    <button type="button" onclick="window.location.reload()" class="relative hidden sm:inline-flex items-center justify-center w-9 h-9 text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded-full transition-colors active:scale-95" title="Refresh Page">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>
                    </button>
            ...
            <main class="p-8">
                @if(session('success'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)" x-transition.duration.500ms
                         class="mb-8 p-4 rounded-lg bg-green-50 border border-green-100 flex items-start text-green-800">
                ...
                @if(session('error'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" x-transition.duration.500ms
                         class="mb-8 p-4 rounded-lg bg-red-50 border border-red-100 flex items-start text-red-800">
