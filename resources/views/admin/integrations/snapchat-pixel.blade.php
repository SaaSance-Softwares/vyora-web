...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        <div class="w-12 h-12 bg-[#FFFC00] border border-gray-200 rounded-xl flex items-center justify-center shrink-0 shadow-sm overflow-hidden">
            <img src="https://developers.snap.com/img/logo-full.svg" alt="Snapchat" class="w-8 h-8 object-contain" />
        </div>
        <div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Turn on Snapchat Pixel tracking for your storefront</p>
                        </div>
                ...
                <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                        ...
                        <span class="text-xs font-semibold text-gray-400">Snapchat Events Manager</span>
                    </div>
                    
                    <div class="p-6 space-y-5">
                        <div>
                            <label class="block text-xs font-black uppercase tracking-widest text-gray-500 mb-2">Snapchat Pixel ID</label>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="accessToken" name="access_token" value="{{ old('access_token', $saved['access_token'] ?? '') }}"
                                    class="w-full bg-gray-50 border-0 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-inset focus:ring-yellow-500 rounded-xl px-4 py-3 text-sm font-medium text-gray-900 placeholder:text-gray-400 pr-12"
                    ...
                    <ol class="space-y-3">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-xs text-gray-600 leading-relaxed">
                                Get your Pixel ID from the Snapchat Events Manager.
                            </span>
                        </li>
                        <li class="flex items-start gap-3">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-5">
                    ...
                    <ol class="space-y-3">
                        <li class="flex items-start gap-3">
                            <span class="w-5 h-5 rounded-full bg-gray-900 text-white text-[10px] font-black flex items-center justify-center shrink-0 mt-0.5">1</span>
                            <span class="text-xs text-gray-600 leading-relaxed">
                                Go to Snapchat Events Manager and select your Pixel.
                            </span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="w-5 h-5 rounded-full bg-gray-900 text-white text-[10px] font-black flex items-center justify-center shrink-0 mt-0.5">2</span>
                            <span class="text-xs text-gray-600 leading-relaxed">
                                Navigate to the <strong>Setup</strong> tab.
                            </span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="w-5 h-5 rounded-full bg-gray-900 text-white text-[10px] font-black flex items-center justify-center shrink-0 mt-0.5">3</span>
                            <span class="text-xs text-gray-600 leading-relaxed">
                                Click on <strong>Conversions API</strong>.
                            </span>
                        </li>
                        <li class="flex items-start gap-3">
