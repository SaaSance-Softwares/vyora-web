...
@section('header', 'Create SMS Template')
...
<div class="w-full">
    ...
    <form action="{{ route('admin.sms-templates.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
        @csrf
        ...
        <div class="p-8 space-y-8">
            ...
            <div>
                ...
                <textarea name="content" rows="4" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm resize-y" required placeholder="Hello {customer_name}, your order #{order_number} is out for delivery!">{{ old('content') }}</textarea>
