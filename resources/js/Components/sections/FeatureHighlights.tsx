                        ...
                        <div key={idx} className="flex flex-col items-center text-center gap-3">
                            ...
                            <div>
                                ...
                                {(item.description || item.desc) && (
                                    <p className={`text-xs md:text-sm mt-1 leading-relaxed ${descColor ? 'opacity-80' : 'text-gray-500'}`} style={descColor ? { color: descColor } : undefined}>{item.description || item.desc}</p>
                                )}
                            </div>
                        </div>
                    ))}
