            ...
            {data.title && (
                <div className="flex justify-between items-end mb-8 md:mb-10">
                    ...
                    <Link 
                        ...
                        className="hidden md:inline-flex font-semibold px-4 py-2 rounded-lg transition-all"
                        style={settings?.primary_color ? { color: settings.primary_color, backgroundColor: `${settings.primary_color}1A` } : { color: '#4f46e5', backgroundColor: '#eef2ff' }}
                    >
                        View All
                    </Link>
                </div>
